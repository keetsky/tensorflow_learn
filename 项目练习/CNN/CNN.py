...
mnist = input_data.read_data_sets('/home/keetsky/Desktop/tensorflow_learn/项目练习/CNN', one_hot=True)
...
def train_neural_network(X, Y):
	...
	optimizer = tf.train.AdamOptimizer(1e-4).minimize(cost_func)  # learning rate 默认 0.001 
